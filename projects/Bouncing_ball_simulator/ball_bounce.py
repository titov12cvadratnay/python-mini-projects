...
background=pygame.image.load(r"C:\Users\titov\Downloads\background-img.jpg")

# sound and text:)
hit_sound = pygame.mixer.Sound(r"C:\Users\titov\Downloads\3bae27a36ef885f.mp3")
...
class ball:
    ball_image=pygame.image.load(r"C:\Users\titov\Downloads\ball.png")
    g=1
    def __init__(self):
        self.velocityX=4
        self.velocityY=4
